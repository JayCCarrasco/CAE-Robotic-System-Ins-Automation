...
def generate_launch_description():
    pkg_share = FindPackageShare(package='mobile_robot_description').find('mobile_robot_description')
    default_model_path = os.path.join(pkg_share, 'src', 'description', 'mobile_robot.urdf')
